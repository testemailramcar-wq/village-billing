...
export default function PayNowButton({ amount, month, year, tier }) {
  ...
  async function handlePay(e) {
    e.preventDefault();
    setLoading(true);
    // TODO: connect to your payment API route
  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div style={{ background: "#fff", borderRadius: "16px", padding: "28px", width: "100%", maxWidth: "420px", margin: "16px", boxShadow: "0 24px 64px rgba(0,0,0,0.18)" }}>
            {paid ? (
              ...
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                  ...
                  <button type="button" onClick={() => setOpen(false)} style={{ background: "none", border: "none", fontSize: "22px", cursor: "pointer", color: "#9CA3AF", lineHeight: 1 }}>×</button>
                </div>

                {/* Bill summary */}
                <div style={{ background: "#F8FAFC", borderRadius: "10px", padding: "14px 16px", marginBottom: "20px", border: "1px solid #F1F5F9" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", color: "#6B7280", marginBottom: "6px" }}>
                    <span>{month} {year} — {tier}</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "22px", fontWeight: 700, color: "#0f2744" }}>
                    <span>Total due</span>
                    <span>₱{amount}</span>
                  </div>
                </div>
                ...
                <form onSubmit={handlePay}>
                  <div style={{ fontSize: "12px", fontWeight: 500, color: "#6b7280", marginBottom: "10px", letterSpacing: "0.3px" }}>Select payment method</div>
