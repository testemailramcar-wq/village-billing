      ...
      <main style={{ padding: "28px 32px", maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "16px", marginBottom: "24px" }}>
          {metrics.map((m) => (
            <div key={m.label} style={{ background: "#fff", borderRadius: "12px", border: "1px solid #F1F5F9", padding: "20px" }}>
              <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: m.bg, marginBottom: "12px" }}></div>
              <div style={{ fontSize: "26px", fontWeight: 700, color: m.color, marginBottom: "2px" }}>{m.value}</div>
              <div style={{ fontSize: "12px", fontWeight: 500, color: "#374151" }}>{m.label}</div>
        ...
        <div style={{ background: "#fff", borderRadius: "12px", border: "1px solid #F1F5F9", padding: "20px", marginBottom: "24px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            ...
            <div style={{ fontSize: "22px", fontWeight: 700, color: "#0F6E56" }}>67.6%</div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ background: "#fff", borderRadius: "12px", border: "1px solid #F1F5F9", padding: "20px", flex: 1 }}>
              ...
              {overdue.map((r, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px 0", borderBottom: i < overdue.length - 1 ? "1px solid #F8FAFC" : "none" }}>
                  <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "#FEE2E2", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: 600, color: "#A32D2D", flexShrink: 0 }}>
                    {initials(r.name)}
                  </div>
                  <div style={{ flex: 1 }}>
